...
function tokenColor(scope, color, fontStyle) {
    return {
        name: scope,
        scope: [scope],
 ...
 */
function _buildTokenColors(obj) {
    const tokenColors = [];
 ...
 */
function generateVSCodeTheme(t) {
    const c = (0, types_1.colorFactory)(t);
    const s = (0, types_1.semanticFactory)(t);
    const sc = (0, types_1.strictColorFactory)(t);
    ...
    return {
        ...
        tokenColors: [
            ...
            tokenColor("punctuation.definition.template-expression", c("tokens.literals.string")),
            ...
            tokenColor("entity.other.inherited-class", c("tokens.types.class"), "bold underline"),
 ...
 */
function mapVSCode(theme, options) {
    ...
    if (!options?.basePath) {
        ...
        if (!baseTheme) {
            ...
            result = {
                ...
                tokenColors: mergeTokenColors(baseTheme.tokenColors || [], generated.tokenColors),
                semanticHighlighting: true,
                semanticTokenColors: deepMerge(baseTheme.semanticTokenColors || {}, generated.semanticTokenColors),
            };
        }
    }
    ...
    if (Object.keys(filters).length > 0) {
        result = (0, filters_1.applyFiltersToTheme)(result, filters);
    }
    return result;
}

...
exports.slate = exports.v = exports.CRIMSON = exports.WATERMELON = exports.ORCHID = exports.GOLD = exports.CYAN = exports.LAVENDER = exports.GRAPE = exports.MINT = exports.CELERY = exports.STORMGRAY = exports.SAGEGRAY = exports.DUSTYBLUE = exports.VANILLACREAM = exports.MUTEDWHITE = exports.MIDNIGHT = exports.WHITE = void 0;
...
exports.WHITE = "#d1d3d9";
exports.MIDNIGHT = "#0e0e15";
exports.MUTEDWHITE = "#a7a4af";
exports.VANILLACREAM = "#f5e0dc";
exports.DUSTYBLUE = "#91aac0";
exports.SAGEGRAY = "#829297";
exports.STORMGRAY = "#767a92";
exports.CELERY = "#b1d36d";
exports.MINT = "#73bf9c";
exports.GRAPE = "#8564d8";
exports.LAVENDER = "#cba6f7";
exports.CYAN = "#33b3cc";
exports.GOLD = "#ffcb6b";
exports.ORCHID = "#e0a2d3";
exports.WATERMELON = "#FF6188";
exports.CRIMSON = "#E60063";
// ============================================================================
// 2. Theme Definition
// ============================================================================
...
const tokens = {
    ...
    comments: (0, utils_1.mix)(palette['#829297'], palette.midnight, 0.5),
    strings: (0, types_1.make)({
        default: palette.celery,
        regex: palette.crimson,
    }),
    operators: {
        default: exports.CRIMSON,
    },
    literals: {
    ...
    keywords: {
        default: (0, utils_1.mix)(palette.mutedwhite, palette.cyan, 0.3),
        operator: exports.CRIMSON,
    },
    variables: {
        default: palette["#a7a4af"],
        parameter: palette["#a7a4af"],
...
const ui = {
    backgrounds: {
        ...
        overlay: (0, utils_1.mix)(palette.semiblack, palette.grape, 0.2),
    ...
    selection: {
        ...
        backgroundInactive: (0, utils_1.transparentize)(palette.mutedwhite, 0.1),
        text: palette.charcoal,
        backgroundActive: (0, utils_1.lighten)(palette.cyan, 0.4),
    },
    highlights: {
...
const components = {
    editor: {
        ...
        selectionHighlight: (0, utils_1.l10)(palette.midnight),
        wordHighlight: palette.charcoal,
        wordHighlightStrong: exports.DUSTYBLUE,
        findMatchHighlight: (0, utils_1.mix)(palette.lavender, palette.midnight, 0.5),
        findMatch: palette.lavender,
        rangeHighlight: (0, utils_1.l10)(palette.midnight),
    },
    editorGutter: {
        background: ui.backgrounds.base,
    ...
    input: {
        ...
        foreground: (0, utils_1.lighten)(palette.mist, 0.1), border: palette.steel,
